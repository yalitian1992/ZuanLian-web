...
// 资源加载函数
    var imgUrls = [
        ...
        {name: "pic_58", path:"images/diamonds/58.png"},
        {name: "pic_59", path:"images/diamonds/59.png"},
        {name: "pic_60", path:"images/diamonds/60.png"},
        {name: "pic_61", path:"images/diamonds/61.png"}
    ];
